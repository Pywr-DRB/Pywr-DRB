...
for test in ['old', 'new']:
    print(f'Running {test} implementation.')
    ...
    if test == 'new':
        ...
        from old_drb_make_model import drb_make_model
    ...
    make_time = time.time() - start_make
    print(f'Time to make model: {make_time}')
    ...
    print(f'Time to run model: {run_time} and total: {run_time + make_time}')
