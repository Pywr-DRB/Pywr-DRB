...
if __name__ == "__main__":
    ...
    pywr_models = ['obs_pub_nhmv10', 'obs_pub_nwmv21',
                   'obs_pub_nhmv10_ObsScaled', 'obs_pub_nwmv21_ObsScaled'] #, 'obs_pub_nhmv10_ObsScaled_ensemble', 'obs_pub_nwmv21_ObsScaled_ensemble',]
    ...
    rrv_models = ['obs', 
                  ...
                  'obs_pub_nhmv10_ObsScaled', 'pywr_obs_pub_nhmv10_ObsScaled']
    ...
    # plot_3part_flows(reservoir_downstream_gages, ['obs_pub_nhmv10_ObsScaled'], 'pepacton', fig_dir = fig_dir)
    # plot_3part_flows(reservoir_downstream_gages, ['pywr_obs_pub_nhmv10_ObsScaled'], 'pepacton', fig_dir = fig_dir)
    # plot_3part_flows(reservoir_downstream_gages, ['obs_pub_nhmv10_ObsScaled', 'pywr_obs_pub_nhmv10_ObsScaled'], 'pepacton', fig_dir = fig_dir)

    # plot_3part_flows(reservoir_downstream_gages, ['obs_pub_nhmv10_ObsScaled', 'pywr_obs_pub_nhmv10_ObsScaled'], 'cannonsville', fig_dir = fig_dir)
    # plot_3part_flows(reservoir_downstream_gages, ['obs_pub_nhmv10_ObsScaled', 'pywr_obs_pub_nhmv10_ObsScaled'], 'neversink', fig_dir = fig_dir)


    print('Plotting weekly flow distributions at reservoirs.')
    # plot_weekly_flow_distributions(reservoir_downstream_gages, ['obs_pub_nhmv10_ObsScaled', 'pywr_obs_pub_nhmv10_ObsScaled'], 'pepacton', fig_dir = fig_dir)
    # plot_weekly_flow_distributions(reservoir_downstream_gages, ['obs_pub_nhmv10_ObsScaled', 'pywr_obs_pub_nhmv10_ObsScaled'], 'cannonsville', fig_dir = fig_dir)
    # plot_weekly_flow_distributions(reservoir_downstream_gages, ['obs_pub_nhmv10_ObsScaled', 'pywr_obs_pub_nhmv10_ObsScaled'], 'neversink', fig_dir = fig_dir)

    ### now do figs for major flow locations


    ### flow comparisons for major flow nodes
    # plot_3part_flows(major_flows, ['obs_pub_nhmv10_ObsScaled', 'pywr_obs_pub_nhmv10_ObsScaled'], 'delMontague', fig_dir = fig_dir)
    # plot_3part_flows(major_flows, ['obs_pub_nhmv10_ObsScaled', 'pywr_obs_pub_nhmv10_ObsScaled'], 'delTrenton', fig_dir = fig_dir)
    # plot_3part_flows(major_flows, ['obs_pub_nhmv10_ObsScaled', 'pywr_obs_pub_nhmv10_ObsScaled'], 'outletSchuylkill', fig_dir = fig_dir)
    # plot_weekly_flow_distributions(major_flows, ['obs_pub_nhmv10_ObsScaled', 'pywr_obs_pub_nhmv10_ObsScaled'], 'delMontague', fig_dir = fig_dir)
    # plot_weekly_flow_distributions(major_flows, ['obs_pub_nhmv10_ObsScaled', 'pywr_obs_pub_nhmv10_ObsScaled'], 'delTrenton', fig_dir = fig_dir)
    # plot_weekly_flow_distributions(major_flows, ['obs_pub_nhmv10_ObsScaled', 'pywr_obs_pub_nhmv10_ObsScaled'], 'outletSchuylkill', fig_dir = fig_dir)
    ...
    plot_combined_nyc_storage(storages, reservoir_downstream_gages, 
                              ['pywr_obs_pub_nhmv10_ObsScaled'], start_date=start_date, end_date=end_date, fig_dir = fig_dir,
                              add_ffmp_levels=False)
    
    ## 1960s drought
    plot_combined_nyc_storage(storages, reservoir_downstream_gages, 
                              ['pywr_obs_pub_nhmv10_ObsScaled'], start_date='1962-01-01', end_date='1970-01-01', fig_dir = fig_dir)

    ## 2002 drought
    plot_combined_nyc_storage(storages, reservoir_downstream_gages,
                              ['pywr_obs_pub_nhmv10_ObsScaled'], start_date='2000-01-01', end_date='2003-12-31', fig_dir = fig_dir,
    ...
    p_end='2020-07-01'
    plot_combined_nyc_storage(storages, reservoir_downstream_gages,
                              ['pywr_obs_pub_nhmv10_ObsScaled'], start_date=p_start, end_date=p_end, fig_dir = fig_dir,
                              add_ffmp_levels=False, plot_observed=False, plot_sim=False, filename_addon='_part1')
    ...
    plot_combined_nyc_storage(storages, reservoir_downstream_gages,
                              ['pywr_obs_pub_nhmv10_ObsScaled'], start_date='2016-01-01', end_date='2018-12-31', fig_dir = fig_dir)

    plot_combined_nyc_storage(storages, reservoir_downstream_gages,
                              ['pywr_obs_pub_nhmv10_ObsScaled'], start_date= '2014-09-17', end_date= '2017-05-17', fig_dir = fig_dir)

                        
    # ## Post-2017
    # plot_combined_nyc_storage(storages, reservoir_downstream_gages, 
    #                           ['pywr_obs_pub_nhmv10_ObsScaled'], start_date='2019-01-01', end_date='2020-12-31', fig_dir = fig_dir)
    plot_combined_nyc_storage(storages, reservoir_downstream_gages, 
                              ['pywr_obs_pub_nhmv10_ObsScaled'], start_date='2018-01-01', end_date='2020-12-31', fig_dir = fig_dir)
    ...
    plot_combined_nyc_storage(storages, reservoir_downstream_gages, 
                                ['pywr_obs_pub_nhmv10_ObsScaled'], start_date='2000-01-01', end_date='2020-12-31', 
                                fig_dir = fig_dir, filename_addon='_unscaled')

    # ## Radial metric plots
    # nodes = ['cannonsville', 'pepacton', 'neversink', 'fewalter', 'beltzvilleCombined', 'blueMarsh']
    # radial_models = ['obs', 'obs_pub_nhmv10_ObsScaled', 'pywr_obs_pub_nhmv10_ObsScaled', 
    #                  'obs_pub_nwmv21_ObsScaled', 'pywr_obs_pub_nwmv21_ObsScaled']
    ...
    node = 'delTrenton'
    models = ['pywr_obs_pub_nhmv10_ObsScaled', 'pywr_obs_pub_nhmv10']
    for model in models:  
