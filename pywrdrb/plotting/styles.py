...
base_model_colors = {'obs': '#191919', # Dark grey
                ...
                'WEAP_23Aug2022_gridmet': '#1F6727', # teal cyan
                ...
                'pywr_WEAP_23Aug2022_gridmet_nhmv10': '#1F6727'} # darker teal
...
paired_model_colors = {'obs': '#2B2B2B',
                ...
                'WEAP_23Aug2022_gridmet': '#95F19F', # lt grn
                'pywr_obs_pub':'#0f6da9', # darker grey-blue
                'pywr_nhmv10': '#B58800', # darker yellow
                'pywr_nwmv21': '#9E1145', # darker green
                'pywr_nwmv21_withLakes': '#9E1145', # darker green
                'pywr_WEAP_23Aug2022_gridmet_nhmv10': '#1F6727'} # drk grn
base_marker = "o"
pywr_marker = "x"
...
scatter_model_markers = {'obs': base_marker, # Dark grey
                ...
                'WEAP_23Aug2022_gridmet': base_marker, # mauve
                ...
                'pywr_WEAP_23Aug2022_gridmet_nhmv10': pywr_marker} # darker mauve
...
model_hatch_styles = {'obs': '',
                        ...
                        'pywr_WEAP_23Aug2022_gridmet_nhmv10': '///'}
