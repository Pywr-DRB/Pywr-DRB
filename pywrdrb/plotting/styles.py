...
base_model_colors = {'obs': '#191919', # Dark grey
                'obs_pub_nhmv10_NYCScalingTrue':'#0f6da9', # grey-blue
                'obs_pub_nwmv21_NYCScalingTrue':'#0f6da9', # grey-blue
                'nhmv10': '#B58800', # yellow
                'nwmv21': '#9E1145', # green
                'nwmv21_withLakes': '#9E1145', # green 
                'WEAP_29June2023_gridmet': '#1F6727', # teal cyan
                'pywr_obs_pub_nhmv10_NYCScalingTrue':'#0f6da9', # darker grey-blue
                'pywr_obs_pub_nwmv21_NYCScalingTrue':'#0f6da9', # darker grey-blue
...
paired_model_colors = {'obs': '#2B2B2B',
                'obs_pub_nhmv10_NYCScalingTrue': '#7db9e5', # grey-blue
                'obs_pub_nwmv21_NYCScalingTrue': '#7db9e5', # grey-blue
...
scatter_model_markers = {'obs': base_marker, # Dark grey
                'obs_pub_nhmv10_NYCScalingTrue': base_marker, # grey-blue
                'obs_pub_nwmv21_NYCScalingTrue': base_marker, # grey-blue
                'nhmv10': base_marker, # yellow
                'nwmv21': base_marker, # green
                'nwmv21_withLakes': base_marker, # green 
                'WEAP_29June2023_gridmet': base_marker, # mauve
                'pywr_obs_pub_nhmv10_NYCScalingTrue': pywr_marker, # darker grey-blue
                'pywr_obs_pub_nwmv21_NYCScalingTrue': pywr_marker, # darker grey-blue
                'pywr_nhmv10': pywr_marker, # darker yellow
                'pywr_nwmv21': pywr_marker, # darker green
                'pywr_nwmv21_withLakes': pywr_marker, # darker green
                'pywr_WEAP_29June2023_gridmet': pywr_marker} # darker mauve

node_colors = {}


model_hatch_styles = {'obs': '',
                        'obs_pub_nhmv10_NYCScalingTrue': '',
                        'obs_pub_nwmv21_NYCScalingTrue': '',
                        'nhmv10': '', 
                        'nwmv21': '', 
                        'nwmv21_withLakes': '', 
                        'WEAP_29June2023_gridmet': '',
                        'pywr_nhmv10': '///',
                        'pywr_obs_pub_nhmv10_NYCScalingTrue': '///',
                        'pywr_obs_pub_nwmv21_NYCScalingTrue': '///',
                        'pywr_nwmv21': '///',
