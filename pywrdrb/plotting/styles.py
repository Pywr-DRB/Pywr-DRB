...
scatter_model_markers = {'obs': base_marker, # Dark grey
                'obs_pub_nhmv10_NYCScaled': base_marker, # grey-blue
                'obs_pub_nwmv21_NYCScaled': base_marker, # grey-blue
                ...
                'pywr_obs_pub_nhmv10_NYCScaled': pywr_marker, # darker grey-blue
                'pywr_obs_pub_nwmv21_NYCScaled': pywr_marker, # darker grey-blue
