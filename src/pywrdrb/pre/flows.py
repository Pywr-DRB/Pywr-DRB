...
import pandas as pd
from ..utils import get_dirs_object
...
class NHMFlowDataPreprocessor(DataPreprocessor):
    def __init__(self):
        ...
        self._dirs.data.flows.mkdir("nhmv10") # Create the directory if it does not exist
        self.output_dirs = {
            "gage_flow.csv": self._dirs.data.flows.nhmv10.get() / "gage_flow_mgd.csv",
            "catchment_inflow_mgd.csv": self._dirs.data.flows.nhmv10.get() / "catchment_inflow_mgd.csv",
        }
