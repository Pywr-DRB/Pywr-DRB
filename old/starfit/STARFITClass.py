...
class STARFIT:
    ...
    def release_harmonic(self, time):
        if self.timestep == 'daily':
            time = time/7
        R_avg_t = (self.data['Release_alpha1'] * self.sinNpi(time, 2) +
    ...
    def calc_NOR_hi(self, time):
        ...
        NOR_hi = (self.data['NORhi_mu'] + self.data['NORhi_alpha'] * self.sinNpi(time, 2) +
    ...
    def calc_NOR_lo(self, time):
        ...
        NOR_lo = (self.data['NORlo_mu'] + self.data['NORlo_alpha'] * self.sinNpi(time, 2) +
    ...
    def release_adjustment(self, S_hat, time):
        ...
        epsilon = (self.data['Release_c'] + self.data['Release_p1']*A_t +
