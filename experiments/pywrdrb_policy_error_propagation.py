# -*- coding: utf-8 -*-
"""
STARFIT diagnostics — upgraded plotting & rolling-skill heatmaps.
- Error shading (Sim−Obs) on daily TS
- NSE/KGE/Bias badges on Daily/Monthly/Annual panels
- Storage in % of capacity
- Per-column axis sharing (TS vs FDC)
- Rolling skill heatmap with "Full Period" row exclusion + TwoSlopeNorm

Assumes pywrdrb is installed and your outputs/observations are available.
"""
...
for inflow_type in inflow_types:
    ...
    options = {
    "release_policy_dict": {
        "fewalter": {"type": "STARFITReservoirRelease", "id": "Best Release NSE"},
    }
}
    mb = pywrdrb.ModelBuilder(inflow_type=inflow_type, 
...
reservoirs_of_interest = ["fewalter"]
os.makedirs("figures_fewalter_bestrel_starfit/release", exist_ok=True)
os.makedirs("figures_fewalter_bestrel_starfit/release_storage", exist_ok=True)
...
for res in reservoirs_of_interest:
    for label, (s, e) in drought_periods.items():
        save_release = f"figures_fewalter_bestrel_starfit/release/{safe_label(res)}_{safe_label(label)}_release_diag.png"
        ...
        save_sr = f"figures_fewalter_bestrel_starfit/release_storage/{safe_label(res)}_{safe_label(label)}_stor_release_diag.png"
...
window_days = 30
base_out = os.path.join("figures_fewalter_bestrel_starfit", "rolling_skill", safe_label(metric))
...
print("All figures written to ./figures_fewalter_bestrel_starfit/")
...
def plot_error_time_series_enhanced(
    ...
    period_label="", save_folder="figures_fewalter_bestrel_starfit/error_ts",
...
def plot_error_vs_flow_percentile_enhanced(
    ...
    save_folder="figures_fewalter_bestrel_starfit/error_vs_pct",
...
def plot_seasonal_decadal_panels(
    df_obs, df_sim, reservoirs, period_label,
    save_folder="figures_fewalter_bestrel_starfit/error_vs_pct_seasons",
...
def plot_joint_error_flow_percentile_crisp(
    df_obs, df_sim, reservoirs, period_label,
    save_folder="figures_fewalter_bestrel_starfit/error_vs_pct_joint_crisp",
    gridsize=50
):
    os.makedirs(save_folder, exist_ok=True)
...
plot_error_time_series_enhanced(
    ...
    period_label=period, save_folder="figures_fewalter_bestrel_starfit/release_error_ts",
...
plot_error_vs_flow_percentile_enhanced(
    ...
    save_folder="figures_fewalter_bestrel_starfit/release_error_vs_pct",
...
plot_seasonal_decadal_panels(
    df_obs=df_obs_downstream_gage, df_sim=df_nwm_downstream_gage,
    reservoirs=reservoirs_of_interest, period_label=period,
    save_folder="figures_fewalter_bestrel_starfit/release_error_vs_pct_seasons",
...
plot_joint_error_flow_percentile_crisp(
    df_obs=df_obs_downstream_gage, df_sim=df_nwm_downstream_gage,
    reservoirs=reservoirs_of_interest, period_label=period,
    save_folder="figures_fewalter_bestrel_starfit/release_error_vs_pct_joint_crisp",
    gridsize=50
)
...
plot_error_time_series_enhanced(
    ...
    save_folder="figures_fewalter_bestrel_starfit/storage_error_ts_MG",
...
plot_error_vs_flow_percentile_enhanced(
    ...
    reservoirs=reservoirs_of_interest,
    period_label=period_storage,
    save_folder="figures_fewalter_bestrel_starfit/storage_error_vs_pct_MG",
...
plot_seasonal_decadal_panels(
    ...
    reservoirs=reservoirs_of_interest,
    period_label=period_storage,
    save_folder="figures_fewalter_bestrel_starfit/storage_error_vs_pct_seasons_MG",
    lowess_frac=0.12,
    acceptable_band=500.0
)
...
plot_joint_error_flow_percentile_crisp(
    ...
    reservoirs=reservoirs_of_interest,
    period_label=period_storage,
    save_folder="figures_fewalter_bestrel_starfit/storage_error_vs_pct_joint_crisp_MG",
    gridsize=50
)
...
plot_error_time_series_enhanced(
    ...
    save_folder="figures_fewalter_bestrel_starfit/storage_error_ts_pct",
    window_days=90, lowess_frac=0.10,
...
plot_error_vs_flow_percentile_enhanced(
    ...
    reservoirs=reservoirs_of_interest,
    period_label=period_storage_pct,
    save_folder="figures_fewalter_bestrel_starfit/storage_error_vs_pct_pct",
    acceptable_band=5.0,
    lowess_frac=0.10,
    color_by="decade"
)
...
plot_seasonal_decadal_panels(
    ...
    reservoirs=reservoirs_of_interest,
    period_label=period_storage_pct,
    save_folder="figures_fewalter_bestrel_starfit/storage_error_vs_pct_seasons_pct",
    lowess_frac=0.12,
    acceptable_band=5.0
)
...
plot_joint_error_flow_percentile_crisp(
    ...
    reservoirs=reservoirs_of_interest,
    period_label=period_storage_pct,
    save_folder="figures_fewalter_bestrel_starfit/storage_error_vs_pct_joint_crisp_pct",
    gridsize=50
)
...
def plot_period_stacked_fdcs(
    ...
    save_folder="figures_fewalter_bestrel_starfit/stacked_fdcs", include_regex=None,
...
for res in reservoirs_of_interest:
    ...
    plot_period_stacked_fdcs(
        ...
        reservoir=res,
        drought_periods=drought_periods,
        save_folder="figures_fewalter_bestrel_starfit/dist/stacked_fdcs",
...
def plot_release_to_downstream_fdcs(
    ...
    save_folder: str = "figures_fewalter_bestrel_starfit/error_propagation",
...
for res in reservoirs_of_interest:
    for period_label in drought_periods.keys():
        plot_release_to_downstream_fdcs(
            ...
            save_folder="figures_fewalter_bestrel_starfit/error_propagation"
        )
...
def plot_trenton_with_lb_activation_one(
    ...
    period_label: str,
    drought_periods: dict,
    save_folder: str = "figures_fewalter_bestrel_starfit/lb_activation",
    ...
    Saves: figures_fewalter_bestrel_starfit/lb_activation/trenton_lb_activation_<period>.png
    """
    start, end = drought_periods[period_label]
...
run_trenton_lb_activation_all_periods(
    ...
    save_folder="figures_fewalter_bestrel_starfit/lb_activation",
    legend_ncols=3
)
